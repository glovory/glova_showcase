            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                OvaButton(
                  ...
                  child: (radioValue != 3) ? Text('Original Button') : null,
                ...
                OvaButtonTheme(
                  data: OvaButtonThemeData(
                    swatch: OvaTheme.of(context).colorSwatch.copyWith(
                          primaryColor: AppColor.primary,
                        ),
                  ),
                  child: OvaButton(
                    onPress: isEnabled ? () {} : null,
                    child: (radioValue != 3) ? Text('Only Change Primary Color') : null,
                    icon: (radioValue != 0) ? Icon(Icons.star) : null,
                    isLeading: (radioValue == 1) ? true : false,
                    status: enumFromString(status, OvaButtonStatus.values),
                    size: enumFromString(size, OvaButtonSize.values),
                ...
                OvaButtonTheme(
                  data: OvaButtonThemeData(
                    ...
                    padding: {
                      OvaButtonSize.medium:
                          OvaPadding.only(top: 10, left: 30, right: 10, bottom: 30),
                    },
                  ),
                  child: OvaButton(
                    onPress: isEnabled ? () {} : null,
                    child: (radioValue != 3) ? Text('Change All Swatch Color') : null,
                    icon: (radioValue != 0) ? Icon(Icons.star) : null,
                    isLeading: (radioValue == 1) ? true : false,
                    status: enumFromString(status, OvaButtonStatus.values),
                    size: enumFromString(size, OvaButtonSize.values),
